function randomIntFromInterval(min,max) {
  ...
  // Loader 5
  const loader5Front = document.querySelector('.loader5__front');
  ...
  // Loader 6
  const loader6__circles = document.querySelectorAll('.loader6 circle');
  let loader6Count;
  ...
  // Loader 11
  const loader11Timeline = new TimelineMax({repeat: -1});
